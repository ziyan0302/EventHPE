            ...
            if (1):
                ...
                for iImg in range(0, numImgsInSplit):
                    ...
                    if (0):
                        ...
                        tmpE = np.clip(events_xys.detach().cpu().numpy().astype(np.uint16), 0, [Width-1, Height-1])
                        tmpE.max()
                        tmpE.min()
                        image_warped[tmpE[:,1], tmpE[:,0]] = [255,0,255]
                        image_warped[tmpE[:,1]+1, tmpE[:,0]] = [255,0,255]
                        image_warped[tmpE[:,1]-1, tmpE[:,0]] = [255,0,255]
                        image_warped[tmpE[:,1], tmpE[:,0]+1] = [255,0,255]
                        image_warped[tmpE[:,1], tmpE[:,0]-1] = [255,0,255]
                        image_warped[tmpJ[:,1], tmpJ[:,0]] = [0,0,255]
                        image_warped[tmpJ[:,1]+1, tmpJ[:,0]] = [0,0,255]
                        image_warped[tmpJ[:,1]-1, tmpJ[:,0]] = [0,0,255]
                        ...
                        image_warped[selectedJ[:,1], selectedJ[:,0]] = [0,255,255]
                        image_warped[selectedJ[:,1]+1, selectedJ[:,0]] = [0,255,255]
                        image_warped[selectedJ[:,1]-1, selectedJ[:,0]] = [0,255,255]
                        image_warped[selectedJ[:,1], selectedJ[:,0]+1] = [0,255,255]
                        image_warped[selectedJ[:,1], selectedJ[:,0]-1] = [0,255,255]
...
def get_args():
    ...
    parser.add_argument('--temp_loss', type=float, default=0.08) #80
    parser.add_argument('--cor_loss', type=float, default=0.05) #50
